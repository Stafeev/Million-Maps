...
@property (nonatomic, strong) NSMutableDictionary *name_map;
...
@property (nonatomic, strong) NSMutableDictionary *issubscribe_map;
@property (nonatomic, strong) NSMutableDictionary *desc_map;
